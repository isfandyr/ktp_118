...
@NamedQueries({
    ...
    @NamedQuery(name = "Data.findByJeniskelamiin", query = "SELECT d FROM Data d WHERE d.jeniskelamiin = :jeniskelamiin"),
...
public class Data implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "jeniskelamiin")
    private String jeniskelamiin;
    @Basic(optional = false)
    @Column(name = "alamat")
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String jeniskelamiin, String alamat, String agama, String status, String warganegara) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
        this.tgllahir = tgllahir;
        this.jeniskelamiin = jeniskelamiin;
        this.alamat = alamat;
        this.agama = agama;
        this.status = status;
    ...
    public String getJeniskelamiin() {
        return jeniskelamiin;
    }

    public void setJeniskelamiin(String jeniskelamiin) {
        this.jeniskelamiin = jeniskelamiin;
    }
    ...
    public String toString() {
        return "unu.jogja.projek.ktp.Data[ id=" + id + " ]";
    }
